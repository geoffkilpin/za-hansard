...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'za_hansard_question', ['id_number', 'house', 'year'])

        # Removing unique constraint on 'Question', fields ['president_number', 'house', 'year']
        db.delete_unique(u'za_hansard_question', ['president_number', 'house', 'year'])

        # Removing unique constraint on 'Question', fields ['oral_number', 'house', 'year']
        db.delete_unique(u'za_hansard_question', ['oral_number', 'house', 'year'])

        # Removing unique constraint on 'Question', fields ['dp_number', 'house', 'year']
        db.delete_unique(u'za_hansard_question', ['dp_number', 'house', 'year'])

        # Removing unique constraint on 'Question', fields ['written_number', 'house', 'year']
        db.delete_unique(u'za_hansard_question', ['written_number', 'house', 'year'])


    def backwards(self, orm):
        # Adding unique constraint on 'Question', fields ['written_number', 'house', 'year']
        db.create_unique(u'za_hansard_question', ['written_number', 'house', 'year'])

        # Adding unique constraint on 'Question', fields ['dp_number', 'house', 'year']
        db.create_unique(u'za_hansard_question', ['dp_number', 'house', 'year'])

        # Adding unique constraint on 'Question', fields ['oral_number', 'house', 'year']
        db.create_unique(u'za_hansard_question', ['oral_number', 'house', 'year'])

        # Adding unique constraint on 'Question', fields ['president_number', 'house', 'year']
        db.create_unique(u'za_hansard_question', ['president_number', 'house', 'year'])

        # Adding unique constraint on 'Question', fields ['id_number', 'house', 'year']
        db.create_unique(u'za_hansard_question', ['id_number', 'house', 'year'])
